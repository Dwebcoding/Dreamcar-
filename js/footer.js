...
(function() {
     ...
     */
    const FOOTER_CONFIG = {
        companyName: 'DreamCar',
        legalAddress: 'V.le Marconi 1 - 24044 - Dalmine (BG)',
        operativeAddress: 'Via Vaccarezza 10, 24040, Osio Sopra (BG)',
        email: 'Dreamcarsrl.curno@gmail.com',
        phone: '39035500613',
        phoneFormatted: '+39 035 500613',
        phoneMobile: '393486127749',
        phoneMobileFormatted: '+39 348 612 7749',
    ...
    const generateFooterHTML = () => {
        ...
        return `
            <div class="footer-content">
                <div a href="${basePath}index.html">
                    ...
                    <div class="footer-company-info">
                        ...
                        <p><i class="fas fa-phone"></i> Tel. Aziendale: <a href="tel:${config.phone}">${config.phoneFormatted}</a></p>
                        <p><i class="fas fa-mobile-alt"></i> Cell: <a href="tel:${config.phoneMobile}">${config.phoneMobileFormatted}</a></p>
